...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["View"] = __webpack_require__(1);
	...
	var View = (function (_super) {
	    ...
	    function View(props) {
	        ...
	        this.handleClick = function () {
	            return _this.setState({ on: !_this.state.on });
	        };
	    }
	    View.prototype.render = function () {
	        return React.createElement("div", null, 
	            React.createElement("h1", null, this.props.Model.Message), 
	            React.createElement("a", {onClick: this.handleClick}, "click"), 
	            React.createElement("span", null, this.state.on ? 'on' : 'off'));
	    };
	    return View;
	}(React.Component));
